...
import "./content.css";
import "./images/cursor_top_left.svg";
import "./images/cursor_top_right.svg";
import "./images/cursor_bottom_left.svg";
import "./images/cursor_bottom_right.svg";
...
class GotchaDude extends React.Component {
  constructor(props) {
    ...
    this.handleMouseBroken = this.handleMouseBroken.bind(this);
  }
  ...
  render() {
    const { cursorGrabbed, mouseBroken, gameOver, debug } = this.state;
    const screenStyle = cursorGrabbed || mouseBroken ? { cursor: "none" } : {};
          ...
          // Render Children
            return (
              <div className={appClass} style={screenStyle}>
                ...
                <MouseBreaker onMouseBroken={this.handleMouseBroken} mouseBroken={this.mouseBroken} />
...
const MouseBreaker = ({onMouseBroken, mouseBroken}) => {
  const [mouseBreakerRef, mouseBreakerHovered] = useHover();
  ...
  if(!mouseBroken){
    cursorFragStyle.left = mousePos.x + 'px';
    cursorFragStyle.top = mousePos.y + 'px';
  }
  
  let yAxis, xFarLeft, xCloseLeft, xFarRight, xCloseRight = '';

  if(mouseBreakerHovered){
    xFarLeft = "xFarLeft";
    xCloseLeft = "xCloseLeft";
    xFarRight = "xFarRight";
    xCloseRight = "xCloseRight";
    yAxis = "animated yAxis";
    cursorFragStyle.display = '';
  }
  ...
  return (
    <div>
      <div 
        ...
        onMouseEnter={onMouseBroken}
      />
      <div class={yAxis} style={cursorFragStyle}>
        <img className={"cursor_frag animated xAxis " + xFarLeft} src={chrome.runtime.getURL("/static/media/cursor_top_left.svg")} />
        <img className={"cursor_frag animated xAxis " + xCloseLeft} src={chrome.runtime.getURL("/static/media/cursor_top_right.svg")} />
        <img className={"cursor_frag animated xAxis " + xCloseRight} src={chrome.runtime.getURL("/static/media/cursor_bottom_left.svg")} />
        <img className={"cursor_frag animated xAxis " + xFarRight} src={chrome.runtime.getURL("/static/media/cursor_bottom_right.svg")} />
      </div>
    </div>
  );
}
